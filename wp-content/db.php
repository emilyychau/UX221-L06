...
$sqlite_plugin_implementation_folder_path = __DIR__.'/mu-plugins/sqlite-database-integration/';
...
add_action(
	...
	function() {
		...
		if ( is_plugin_inactive( __DIR__.'/mu-plugins/sqlite-database-integration/load.php' ) ) {
			...
			if ( null !== activate_plugin( __DIR__.'/mu-plugins/sqlite-database-integration/load.php', '', false, true ) ) {
